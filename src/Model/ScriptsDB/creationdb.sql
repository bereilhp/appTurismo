...
CREATE TABLE place (id_place INT NOT NULL AUTO_INCREMENT, name_place VARCHAR(200) NOT NULL, description_place VARCHAR(2000) NOT NULL, schedule VARCHAR(50) NOT NULL, link_place VARCHAR(200) NOT NULL, id_icon INT NOT NULL, latitude decimal(7,5) NOT NULL, longitude decimal(7,5) NOT NULL, PRIMARY KEY (id_place), FOREIGN KEY (id_icon) REFERENCES icon(id_icon));
